...
namespace SudokuSolverTest
{
    public class SolverTests
    {
        ...
        [InlineData("Training/Pointing Tuples.txt", "732456198419283756685971423528197634964835271371624985296518347843762519157349862", 12, "Pointing tuple      Starting in blockrow 2's 2nd block, 2nd row: ( 8, 5 )")]
